...
ASTWalker.prototype = {
  ...
  "translateLoop": function(fun) {
    return this.shadowVars(function(translator) {
      var current = translator.loopTranslate;
      var returned = translator.returnTranslated;
      translator.loopTranslate = true;
      translator.returnTranslated = false;
      ...
      if(translator.returnTranslated) {
      ...
      translator.loopTranslate = current;
      translator.returnTranslated = returned;
  ...
  "REPEAT": function(current) {
    return this.translateLoop(function(translator){
  ...
  "RETURN": function(current) {
    ...
    if(this.loopTranslate) {
      this.returnTranslated = true;
